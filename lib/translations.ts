export const translations = {
  ...
  en: {
    ...
    faq: {
      ...
      termosText:
        'The terms ensure that the customer is aware of the technical regulations required by certifications such as INMETRO and ANATEL and define legal responsibilities related to label usage.',
      contatoTitle: 'How can I contact you?',
      contatoText: 'You can email certificacao@grupoativa.net or talk to us on WhatsApp.',
      contatoEmail: 'certificacao@grupoativa.net',
      contatoWhatsappText: 'Hello, I would like to speak with Apoema!',
    },
  },
  ...
  zh: {
    ...
    faq: {
      ...
      termosText:
        '条款可确保客户了解 INMETRO 和 ANATEL 等认证所需的技术要求，并明确标签使用相关的法律责任。',
      contatoTitle: '如何联系你们？',
      contatoText: '您可以发送电子邮件至 certificacao@grupoativa.net 或通过 WhatsApp 与我们联系。',
      contatoEmail: 'certificacao@grupoativa.net',
      contatoWhatsappText: '你好，我想和 Apoema 说话！',
    },
  },
};
